...
struct Celsius {
    ...
    init(fromFahren fahren: Double){
        self.temperature = (fahren - 32) / 1.8
    }
...
let boilingPoint = Celsius(fromFahren: 212)
let frezingPoint = Celsius(fromKelvin: 273.15)
...
q1.ask()
q1.response = "Sí, Me caerian unos de pta madre"
